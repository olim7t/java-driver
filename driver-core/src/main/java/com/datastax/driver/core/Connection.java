...
class Connection {
    ...
    protected Connection(String name, InetSocketAddress address, Factory factory) throws ConnectionException, InterruptedException, UnsupportedProtocolVersionException, ClusterNameMismatchException {
        ...
        bootstrap.handler(new ChannelInitializer(this, protocolVersion, protocolOptions.getCompression().compressor, protocolOptions.getSSLOptions()));
    ...
    private static class ChannelInitializer extends io.netty.channel.ChannelInitializer<SocketChannel> {
        ...
        public ChannelInitializer(Connection connection, int protocolVersion, FrameCompressor compressor, SSLOptions sslOptions) {
            this.connection = connection;
